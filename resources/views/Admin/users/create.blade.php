<form action="{{ route('admin.users.store') }}" method="POST" id="form-tambah" enctype="multipart/form-data">
    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group nim-field">
                            ...
                            <small class="form-text text-muted">Isi kolom NIM jika anda ingin menambahkan Mahasiswa</small>
                        ...
                        <div class="form-group nip-field">
                            ...
                            <small class="form-text text-muted">Isi kolom NIP jika anda ingin menambahkan selain Mahasiswa</small>
...
$(document).ready(function() {
    ...
    $('#avatar').change(function() {
        ...
        if (file) {
            ...
            // Set file name in label - using both methods to ensure compatibility
