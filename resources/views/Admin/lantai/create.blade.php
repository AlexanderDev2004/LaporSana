<form action="{{ route('admin.lantai.store') }}" method="POST" id="form-tambah">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="lantai_kode" id="lantai_kode" class="form-control" required>
                    <small id="error-lantai_kode" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Nama Lantai</label>
                    <input type="text" name="lantai_nama" id="lantai_nama" class="form-control" required>
