            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="ruangan_id" id="ruangan_id" class="form-control" required>
                            ...
                            @foreach ($ruangan as $r)
                                <option {{ ($r->ruangan_id == $fasilitas->ruangan_id) ? 'selected' : ''}}
                                    value="{{ $r->ruangan_id }}">{{ $r->ruangan_nama }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $fasilitas->fasilitas_kode }}" type="text" name="fasilitas_kode"
                            id="fasilitas_kode" class="form-control" required>
                        <small id="error-fasilitas_kode" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Nama Fasilitas</label>
                        <input value="{{ $fasilitas->fasilitas_nama }}" type="text" name="fasilitas_nama"
                            id="fasilitas_nama" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="tingkat_urgensi" name="tingkat_urgensi" required>
                            <option value="1" {{ isset($fasilitas) && $fasilitas->tingkat_urgensi == 1 ? 'selected' : '' }}>1
                                - Sangat tidak penting</option>
                            <option value="2" {{ isset($fasilitas) && $fasilitas->tingkat_urgensi == 2 ? 'selected' : '' }}>2
                                - Cukup tidak penting</option>
                            <option value="3" {{ isset($fasilitas) && $fasilitas->tingkat_urgensi == 3 ? 'selected' : '' }}>3
                                - Netral</option>
                            <option value="4" {{ isset($fasilitas) && $fasilitas->tingkat_urgensi == 4 ? 'selected' : '' }}>4
                                - Cukup penting</option>
                            <option value="5" {{ isset($fasilitas) && $fasilitas->tingkat_urgensi == 5 ? 'selected' : '' }}>5
