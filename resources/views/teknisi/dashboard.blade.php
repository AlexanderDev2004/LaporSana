                                    ...
                                    <table class="table table-sm table-hover mb-0">
                                        ...
                                        <tbody>
                                            @forelse ($tugasTerbaru as $tugas)
                                                <tr>
                                                    <td class="py-2">{{ $tugas->tugas_fasilitas ?? '-' }}</td>
                                                    <td class="py-2">{{ \Carbon\Carbon::parse($tugas->tugas_mulai)->format('d-m-Y') }}</td>
                                                    <td class="py-2">
                                                        <a href="{{ route('teknisi.show', $tugas->tugas_id) }}" class="text-primary small">Detail Laporan</a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
