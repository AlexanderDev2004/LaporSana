...
<div class="wrapper">
  <!-- Navbar -->
  @include('layouts.pelapor.header')
  <!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-white-primary elevation-4">
   ...
   <!-- Sidebar -->
   @include('layouts.pelapor.sidebar')
   <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    @include('layouts.pelapor.breadcrumb')
  ...
  <!-- /.content-wrapper -->
  @include('layouts.pelapor.footer')
...
<script src="{{ asset('LaporSana/dist/js/demo.js') }}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('LaporSana/dist/js/pages/dashboard.js') }}"></script>
</body>
</html>
