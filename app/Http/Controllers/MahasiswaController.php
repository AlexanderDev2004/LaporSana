...
class MahasiswaController extends Controller
{
    ...
    public function laporan()
    {
        ...
        return view('mahasiswa.laporan.laporan', ['breadcrumb' => $breadcrumbs, 'page' => $page, 'active_menu' => $active_menu]);
    }
    ...
    public function create()
    {
        ...
        $active_menu = 'laporan saya';
        return view('mahasiswa.laporan.create', ['breadcrumb' => $breadcrumbs, 'page' => $page, 'active_menu' => $active_menu]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mahasiswa.laporan')->with('success', 'Laporan berhasil dibuat.');
    }
}
